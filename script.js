...
function showCategory() {
    ...
    if (currentCategory === 'Alcools' && currentSubCategory !== 'all') {
        filtered = filtered.filter(p => {
            ...
            if (currentSubCategory === 'pastis') return contient(['pastis', 'ricard', 'duval', 'raki', 'ouzo', 'bardouin', 'diamant bleu']);
